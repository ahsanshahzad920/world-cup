...
@else
    <div class="media">
        <img class="mr-3" src="{{'/dash-assets/images/small-team1.jpg' }}" alt=" image">
        <div class="media-body">
            <h5 class="mt-0">{{ $message->sender->first_name . ' ' . $message->sender->last_name  }} <small>{{ $message->created_at }}</small></h5>
            <p>{!! $message->text !!}</p>
        </div>
    </div>
@endif